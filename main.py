...
def render():
    ...
    test_obj.euler_rot[1] = 0
    test_obj.euler_rot[2] = np.pi / 2
    test_obj.euler_rot[0] = framecount * 0.001
    # test_obj_2.render()
    test_obj.render()
...
def main():
    ...
    test_obj = obj_loader.load_game_object_from_file('data/models/test_models/trisout.obj', program, scale=1/10, color=[1.0, 0.0, 0.0])
